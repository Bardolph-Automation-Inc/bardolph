...
for test_class in (ClockTest, InjectionTest, JobControlTest, LexTest,
    LightSetTest, LogConfigTest, MachineTest, ParserTest, SettingsTest,
    TimePatternTest, UnitsTest, WebAppTest):
